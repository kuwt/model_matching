...
void stocs_estimator::load_object_info(	std::string model_location,
...
void  stocs_estimator::load_scene_info (std::string rgb_location,
...
static int sample_point_from_distribution(std::vector<Point3D>& point3d)
{
...
bool stocs_estimator::sample_class_base(std::vector<int> &base_indices,
										float &invariant1,
										float &invariant2)
{
	...
	{
		std::cout << "FAILED SAMPLING PT 1:: Zero probability returned!!!" << std::endl;
		return false;
	}
	...
	{
		std::cout << "FAILED SAMPLING PT 2:: Zero probability returned!!!" << std::endl;
		return false;
	}
...
bool stocs_estimator::find_congruent_sets_on_model(	std::vector<int> &base_indices,
													float invariant1, float invariant2,
													std::vector<Quadrilateral>* quadrilaterals)
{

	/********** get base points (scene) ************/
	...
	/********** computing point pair features for the scene base ************/
	...
	/********** search the point pair feature in the model ppf map ************/
...
bool  stocs_estimator::get_rigid_transform_from_congruent_pair(	std::vector<int> &base_indices,
...
Scalar stocs_estimator::compute_alignment_score_for_rigid_transform(const Eigen::Ref<const MatrixType> &mat) 
{
