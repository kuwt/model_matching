...
extern const float normal_radius = 0.005; // (obsolete)In m radius for calculating normal vector of a point, depends on point cloud density
...
extern const float validPairMinDist = 0.04; // In mm, depends on object size, should be at large as possible. Perfect is 80-90 % of object size. 

extern const float lcp_distthreshold = ds_voxel_size * 0.55; // for Congruent Set Matching and LCP computation, depends on point cloud density
