...
// alg parameters
extern const float ds_voxel_size = 0.005; // In m, sampling size
...
extern const float validPairMinDist = 0.08; // depends on object size

extern const float lcp_distthreshold = 0.003; // for Congruent Set Matching and LCP computation, depends on point cloud density
